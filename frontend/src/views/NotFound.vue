  ...
  <div class="min-h-screen bg-gray-50 flex flex-col">
    ...
    <main class="flex-grow flex items-center justify-center py-16 pt-25">
      <div class="container mx-auto px-4 text-center">
        ...
        <div class="mb-8">
          <div
            class="w-48 h-48 mx-auto bg-[#088178] bg-opacity-10 rounded-full flex items-center justify-center"
          >
            <svg class="w-24 h-24 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                ...
                stroke-width="1.5"
                d="M9.172 16.172a4 4 0 015.656 0M9 12h6m-6-4h6m2 5.291A7.962 7.962 0 0112 15c-2.34 0-4.47.87-6.09 2.29M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 8v2m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"
              />
            </svg>
          </div>
        </div>
        ...
        <p class="text-lg text-gray-600 max-w-2xl mx-auto mb-8">
          Oups ! Il semble que la page que vous recherchez ait été déplacée, supprimée ou n'existe
          pas. Nos artisans sont sur le coup pour réparer cela !
        </p>
