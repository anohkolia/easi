...
const serviceOptions = computed(() => {
  ...
  switch (serviceSlug) {
    ...
    case 'carrelage-sol':
      return [
        { value: 'pose-parquet', label: 'Pose de parquet', icon: 'fas fa-th-large' },
        { value: 'pose-pave', label: 'Pose de pavés' },
        { value: 'pose-carrelage', label: 'Pose de carrelage sol ou mural', icon: 'fas fa-th-large' },
        { value: 'refection-joint', label: 'Réfection de joints' },
      ]
    
    case 'serrurerie-menuiserie':
      return [
        { value: 'porte-bois', label: 'Porte en bois', icon: 'fas fa-door-closed' },
        { value: 'porte-metal', label: 'Porte métallique', icon: 'fas fa-door-closed' },
        { value: 'placard', label: 'Placard', icon: 'fas fa-archive' },
        { value: 'baie-vitree', label: 'Baie vitrée', icon: 'fas fa-window-restore' },
        { value: 'fenetre', label: 'Fenêtre', icon: 'fas fa-window-maximize' },
        { value: 'volet', label: 'Volet', icon: 'fas fa-shutter-speed' },
        { value: 'groom', label: 'Groom', icon: 'fas fa-door-open' },
      ]
  }

  // Pour les autres services (ex: Peinture)
  return [{ value: 'standard', label: 'Service Standard', icon: 'fas fa-cogs' }]
})
...
const specificOptions = {
  ...
  peinture: ['Peinture (3 couches)', 'Rafraichissement (2 couches)', 'Décoration murale'],
...
const getSpecificOptions = () => {
  return selectedServiceType.value
    ? specificOptions[selectedServiceType.value as keyof typeof specificOptions]
    : []
}
  ...
  <section class="py-12 bg-gray-50 min-h-screen">
    <div class="container mx-auto px-4 max-w-4xl">
      ...
      <div class="bg-white rounded-xl shadow-md p-6 md:p-8">
        <!-- Type de service -->
        <div class="mb-8">
          <label class="block text-lg font-semibold text-gray-800 mb-4"> Type de service * </label>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              <div class="flex items-center">
                <div
                  class="w-10 h-10 bg-[#088178] bg-opacity-20 rounded-full flex items-center justify-center mr-3"
                >
