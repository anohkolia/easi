...
const formClasses = computed(() => {
  return {
    'bg-white p-6 rounded-lg shadow-lg': props.size === 'large',
...
watch(() => searchData.value.category, (newCategory) => {
  if (newCategory) {
    ...
    <div class="flex flex-col md:flex-row gap-4">
      ...
      <div class="flex-1 relative">
        <div class="relative">
          ...
          >
            <svg v-if="!isGettingLocation" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
