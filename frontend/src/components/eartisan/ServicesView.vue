    ...
    <div class="container mx-auto px-4">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-10">
        ...
        >
          ...
          <div class="absolute inset-0 bg-gradient-to-b from-[#EF7900]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          
          <!-- Contenu avec icône à gauche -->
          <div class="flex items-start space-x-4 relative z-10">
            <!-- Icône Font Awesome -->
            <div class="w-12 h-12 bg-[#088178] bg-opacity-10 rounded-full flex items-center justify-center flex-shrink-0 group-hover:bg-opacity-20 transition-colors duration-300">
              <i :class="service.icon" class="text-white text-lg"></i>
            </div>
            
            <!-- Titre et bouton -->
            <div class="flex-1 min-w-0">
              <h3 class="text-lg font-semibold text-gray-800 mb-2 leading-tight group-hover:text-[#088178] transition-colors duration-300">
                {{ service.title }}
              </h3>
              
              <div class="flex items-center text-[#088178] font-medium group-hover:text-[#EF7900] transition-colors duration-300">
